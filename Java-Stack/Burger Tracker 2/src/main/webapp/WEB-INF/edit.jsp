<%@ page import="com.example.burgertracker2.models.Burger" %>
...
<div class="w-[60%] mx-auto mt-10">
    ...
    <div class="flex justify-between">
        <h1 class="text-4xl text-[#085394] font-bold ml-41 ">Edit Burger</h1>
        <a class="text-4xl underline text-blue-500 mr-41" href="/">Go Back</a>
    </div>
    <form:form modelAttribute="burger" action="/edit/${burger.id}" method="post"
